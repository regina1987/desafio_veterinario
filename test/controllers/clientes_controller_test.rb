...
class ClientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cliente" do
    assert_difference('Cliente.count') do
      post clientes_url, params: { cliente: { mail: @cliente.mail, name: @cliente.name, telef: @cliente.telef } }
    end
  ...
  test "should update cliente" do
    patch cliente_url(@cliente), params: { cliente: { mail: @cliente.mail, name: @cliente.name, telef: @cliente.telef } }
