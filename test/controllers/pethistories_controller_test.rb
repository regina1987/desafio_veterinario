...
class PethistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pethistory" do
    assert_difference('Pethistory.count') do
      post pethistories_url, params: { pethistory: { alto: @pethistory.alto, description: @pethistory.description, peso: @pethistory.peso, pet_id: @pethistory.pet_id } }
    end
  ...
  test "should update pethistory" do
    patch pethistory_url(@pethistory), params: { pethistory: { alto: @pethistory.alto, description: @pethistory.description, peso: @pethistory.peso, pet_id: @pethistory.pet_id } }
